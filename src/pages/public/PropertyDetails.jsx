            ...
            <main className="container mx-auto px-4 pb-12 flex-grow">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        >
                            <div className="mb-4">
                                <span className="bg-yellow-500 text-yellow-900 text-xs font-bold px-4 py-1.5 rounded-full uppercase tracking-wide inline-block">
                        ...
                        <motion.div
                            ...
                            className="bg-white p-6 md:p-8 rounded-3xl shadow-sm border border-gray-100"
                        >
                            <h3 className="text-lg font-bold text-gray-900 mb-4 border-b border-gray-100 pb-2">Location</h3>
                        ...
                        <motion.div
                            ...
                            className="bg-white p-6 md:p-8 rounded-3xl shadow-sm border border-gray-100"
                        >
                            <h3 className="text-lg font-bold text-gray-900 mb-4 border-b border-gray-100 pb-2">Documents</h3>
