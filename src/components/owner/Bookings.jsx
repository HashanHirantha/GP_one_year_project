...
const Bookings = () => {
    ...
    return (
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-8 border-t-4 border-[#06cc50]">
            <h3 className="text-lg font-bold text-gray-900 mb-6">Bookings & Reservations</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div className="border border-gray-100 p-4 rounded-lg shadow-sm text-center">
                    ...
                    <h4 className="text-2xl font-bold text-gray-900 mt-1">47</h4>
                </div>
                <div className="border border-gray-100 p-4 rounded-lg shadow-sm text-center">
                    <span className="text-xs font-bold text-gray-500 uppercase">Active Bookings</span>
                    <h4 className="text-2xl font-bold text-gray-900 mt-1">18</h4>
                </div>
                <div className="border border-gray-100 p-4 rounded-lg shadow-sm text-center">
                    ...
                    <h4 className="text-2xl font-bold text-gray-900 mt-1">10</h4>
                </div>
            </div>

            <h4 className="font-bold text-gray-900 mb-4 text-sm">Booking Calendar</h4>
