...
const Inquiries = () => {
    ...
    return (
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-8 border-t-4 border-[#06cc50]">
            <h3 className="text-lg font-bold text-gray-900 mb-4">All Inquiries</h3>

            <div className="flex gap-2 mb-6">
                <button className="bg-[#06cc50] text-white text-xs font-bold px-4 py-1.5 rounded-full">All (122)</button>
                    ...
                    <div key={index} className="bg-gray-50 p-4 rounded-lg border border-gray-100 relative">
                        <div className="flex justify-between items-start mb-2">
                            ...
                            <div className="text-right">
                                <p className="text-xs font-bold text-gray-900">{iq.property}</p>
                        ...
                        <div className="flex justify-end gap-2">
                            <button className="bg-[#06cc50] hover:bg-[#05b346] text-white text-xs font-bold px-4 py-1.5 rounded flex items-center gap-1 transition shadow-sm">
                                <Reply size={12} /> Reply
                            </button>
